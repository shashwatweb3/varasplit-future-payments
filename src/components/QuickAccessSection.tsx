    ...
    <section className="relative py-20 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <div className="glass-card p-6">
            <h3 className="font-display text-xl font-semibold mb-3">Open VaraSplit</h3>
            <p className="text-muted-foreground mb-6">Launch the live VaraSplit app directly from the landing page.</p>
            <a
